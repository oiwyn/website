export const workContent = [
    ...
    },
    {
        ...
        id: "express-bahari",
        filter: "professional",
        image: require("./expressbahari/cover.png").default,
        desc: {
            type: "Website and App UI/UX Design",
            client: "PT. Pelayaran Sakti Inti Makmur (2019)",
            tools: "Figma, Adobe Xd, Adobe Photoshop, HTML, CSS, JavaScript",
            content: "Express Bahari, one of the biggest ferry service in Indonesia approached me to design their website and their upcoming app.\n\nThey wanted to upgrade its service by building a responsive website that has location-based ferry timetable, promo selections, and most importantly it has to be user friendly no matter on mobile, tablet, or PC. Following the redesign, the company liked my design direction and asked me to do UI/UX design for their upcoming smartphone app that has features, such as allowing users to book and see their trip detail, redeem promo codes, push notification, and rewards system.",
        },
        misc:{
            ...
            image:{
                ...
                content: require("./expressbahari/content.png").default,
            }
        } 
    },
    {
